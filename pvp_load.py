...
# pvp_load.py
# used for loading a file instantly from the launch screen
# doing this allows us to avoid overlapping namespace due to similar approaches
# to the launch screen/game - I wanted them to be separate for organizational
# purposes
...
def run():
    ...
    init(canvas)
    loadData(canvas) # needs to load save file instantly - can now use
    # subprocess access instead of conditions to avoid clashing namespaces
